...
function displayComparison(product1, product2) {
  ...
  comparisonArea.innerHTML = `
    ...
    <div class="konten m-4 d-flex justify-content-center  align-items-start gap-4">
        <div class="data-1 gap-4 d-flex justify-content-center align-items-center flex-column">
            <div class="grafik">
            ...
            <div class="vga w-100 p-4 md:px-5">
                        ...
                        <tr>
                            <td class="overal" style="background-color: #fafafa; width: 35%; ">
                                <div class="text-start">
                                    ...
                                    <div class="bg-white my-2 lg:me-4 rounded-pill">
                                        <div class="d-flex rounded-pill justify-content-center text-white bg-danger align-content-center text-center"
                                            style="width: ${specs1.overal};">
                            ...
                            <td class="overal" style="background-color: #fafafa; width: 35%;">
                                <div class="text-start">
                                    <p>78 POINT</p>
                                    <div class="bg-white my-2 lg:me-4 rounded-pill">
                                        <div class="d-flex rounded-pill justify-content-center text-white bg-orange align-content-center text-center"
                                            style="width: ${specs2.overal};">
                ...
                <div class="to-pc-tab" style="font-size: 12px ">
                    <table class="table table-borderless text-center">
                        ...
                        <tbody>
                            <tr>
                                <td style="background-color: #fafafa" class="fs-6 fw-semibold" scope="row">
                                    ${specs1.vga}
                                </td>
                                <td style="background-color: #efefef">2330Mhz</td>
                                <td style="background-color: #fafafa">24GB</td>
            ...
            <div class="Batenmer w-100 d-flex gap-3">
                <div class="baterai-screen md:w-50">
                    ...
                    <div style="font-size: 12px" class="d-flex flex-column gap-2">
                        ...
                        <div class="screen d-flex justify-content-between align-items-end gap-2">
                ...
                <div>
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner" style="font-size: 12px;">
                            <div class="carousel-item active">
                                ...
                                <div class="d-flex md:px-5 justify-content-center align-items-center">
                                    <div
                                        class="row gx-5 gy-3 md:p-5 p-3 d-flex justify-content-center align-items-center">
                                        ${fitur1}
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item">
                                ...
                                <div class="d-flex md:px-5 justify-content-center align-items-center">
                                    <div
                                        class="row gx-5 md:p-5 p-3 gy-3 d-flex justify-content-center align-items-center">
                                        ${fitur2}
                                    </div>
                                </div>
                            </div>
                        ...
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators"
                            data-bs-slide="prev">
                            <span class="visually-hidden" aria-hidden="true"><img src="../assets/icon/angle-left.png"
                                    class="w-50 md:w-100" alt=""></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators"
                            data-bs-slide="next">
                            <span class="visually-hidden" aria-hidden="true"><img src="../assets/icon/angle-left.png"
                                    class="w-50 md:w-100" style="transform: rotate(180deg);" alt=""></span>
